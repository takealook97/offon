        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="w-[72px]">기본</TableHead>
              <TableHead className="w-[72px]">추가</TableHead>
              <TableHead className="w-[72px]">사용</TableHead>
              <TableHead className="w-[72px]">잔여</TableHead>
